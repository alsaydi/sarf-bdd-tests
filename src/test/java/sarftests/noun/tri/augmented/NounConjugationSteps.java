...
public class NounConjugationSteps {
    ...
    @When("the derived noun is from an augmented verb is {string}")
    public void theDerivedNounIsFromAnAugmentedVerbIs(String nounType) {
        testContext.RootType = RootType.TrilateralAugmented;
        testContext.NounType = NounType.valueOf(nounType);
    }

    @Then("singular masculine nouns of the verb {string} of formula {string} are nominative {string} and accusative {string} and genitive {string}")
    ...
    @And("singular feminine nouns of the verb {string} of formula {string} are nominative {string} and accusative {string} and genitive {string}")
    ...
    @And("dual masculine nouns of the verb {string} of formula {string} are nominative {string} and accusative {string} and genitive {string}")
    ...
    @And("dual feminine nouns of the verb {string} of formula {string} are nominative {string} and accusative {string} and genitive {string}")
    ...
    @And("plural masculine nouns of the verb {string} of formula {string} are nominative {string} and accusative {string} and genitive {string}")
    ...
    @And("plural feminine nouns of the verb {string} of formula {string} are nominative {string} and accusative {string} and genitive {string}")
