...
public class QuadrilateralUnaugmentedPassiveParticipleNounProvider implements INounProvider {
    ...
    @Inject
    public QuadrilateralUnaugmentedPassiveParticipleNounProvider(SarfDictionary sarfDictionary
